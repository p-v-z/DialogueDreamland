...
Import the [Excluded Assets❗](#excluded-assets) using Unity's package manager, place the assets into the following folder structure `/DialogueDreamland/Assets/DDAssets`. Import the plugins (Odin and DOTween) into `/DialogueDreamland/Plugins/`
